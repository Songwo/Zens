...
class TopicPlanner:
    ...
    async def plan(self) -> TopicPlan:
        ...
        source = result.citations[0] if result.citations else None
        ...
        return TopicPlan(
            ...
            metadata={"researchHitCount": result.hit_count, "sourcePostIds": [item.post_id for item in result.citations[:5]]},
        )
